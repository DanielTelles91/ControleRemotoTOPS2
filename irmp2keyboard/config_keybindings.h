...
KeyTable REMOTE_KEYS[] = {
  ...
  // Arrow keys
  {{0x09,0x003d,0x0029,0x00}, MOD_NONE, KEY_LEFT},
  {{0x09,0x003d,0x0028,0x00}, MOD_NONE, KEY_RIGHT},
  {{0x09,0x003d,0x0058,0x00}, MOD_NONE, KEY_UP},
  {{0x09,0x003d,0x0059,0x00}, MOD_NONE, KEY_DOWN},
  // OK-Button
  {{0x09,0x003d,0x00fa,0x00}, MOD_NONE, KEY_ENTER},
  // Back or Exit
  {{0x09,0x003d,0x0083,0x00}, MOD_NONE, KEY_BACKSPACE},
  // Info-Key
...
//  {{}, MOD_NONE, KEY_E},
  ...
  // Pause
  {{0x09,0x003d,0x002d,0x00}, MOD_NONE, KEY_SPACE},
  // Stop
  {{0x09,0x003d,0x0031,0x00}, MOD_NONE, KEY_X},
  // Fast forward
  {{0x09,0x003d,0x0020,0x00}, MOD_NONE, KEY_F},
  // Rewind
  {{0x09,0x003d,0x0021,0x00}, MOD_NONE, KEY_R},
  // Volume up
  {{0x09,0x003d,0x0024,0x00}, MOD_NONE, KEYPAD_ADD},
  // Volume down
  {{0x09,0x003d,0x0023,0x00}, MOD_NONE, KEYPAD_SUBTRACT},
  // Mute
  ...
  {{0x09,0x003d,0x00f1,0x00}, MOD_NONE, KEY_K},
  ...
  {{0x09,0x003d,0x004b,0x00}, MOD_NONE, KEY_T},
  ...
  {{0x09,0x003d,0x00f7,0x00}, MOD_NONE, KEY_Z}, // Y
  ...
  {{0x09,0x003d,0x000c,0x00}, MOD_NONE, KEY_POWER}, // Ein/Aus
};
